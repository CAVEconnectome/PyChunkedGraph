...
Modified to incorporate features in https://github.com/seung-lab/chunked-graph/blob/master_dep/pychunkedgraph/server.jl
...
#sys.path.insert(0, '/home/zashwood/PyChunkedGraph/src/backend') #Include Sven's backend code
sys.path.insert(0, '/usr/people/zashwood/Documents/PyChunkedGraph/pychunkedgraph/backend') #Include Sven's pychunkedgraph code
