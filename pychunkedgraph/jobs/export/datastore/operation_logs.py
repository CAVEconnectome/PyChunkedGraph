...
Uses `GOOGLE_APPLICATION_CREDENTIALS` service account
if `OPERATION_LOGS_DATASTORE_CREDENTIALS` not provided.
"""
...
if __name__ == "__main__":
    ...
    from ....export.to.datastore.config import DEFAULT_NS
