...
class ChunkedGraph(object):
    ...
    def undo_operation(self, user_id: str, operation_id: np.uint64) -> GraphEditOperation.Result:
        ...
        :return: GraphEditOperation.Result
        """
        return UndoOperation(self, user_id=user_id, superseded_operation_id=operation_id, multicut_as_split=False).execute()
    ...
    def redo_operation(self, user_id: str, operation_id: np.uint64) -> GraphEditOperation.Result:
        ...
        :return: GraphEditOperation.Result
        """
        return RedoOperation(self, user_id=user_id, superseded_operation_id=operation_id, multicut_as_split=False).execute()
