...
class TestGraphBuild:
    ...
    def test_build_single_node(self, gen_graph):
        ...
        assert serializers.serialize_uint64(to_label(cg, 1, 0, 0, 0, 0)) in res.rows
        ...
        assert serializers.serialize_uint64(to_label(cg, 2, 0, 0, 0, 1)) in res.rows
        ...
        row = res.rows[serializers.serialize_uint64(to_label(cg, 2, 0, 0, 0, 1))].cells[
            "0"
        ]
    ...
    def test_build_single_edge(self, gen_graph):
        ...
        assert serializers.serialize_uint64(to_label(cg, 1, 0, 0, 0, 1)) in res.rows
    ...
    def test_build_single_across_edge(self, gen_graph):
        ...
        assert serializers.serialize_uint64(to_label(cg, 1, 1, 0, 0, 0)) in res.rows
        ...
        assert serializers.serialize_uint64(to_label(cg, 2, 1, 0, 0, 1)) in res.rows
        atomic_cross_edge_d = cg.get_atomic_cross_edges(
        ...
        attr = attributes.Hierarchy.Child
        row = res.rows[serializers.serialize_uint64(to_label(cg, 2, 1, 0, 0, 1))].cells[
            "0"
        ]
        children = attr.deserialize(row[attr.key][0].value)
        ...
        assert serializers.serialize_uint64(to_label(cg, 3, 0, 0, 0, 1)) in res.rows

        attr = attributes.Hierarchy.Child
        row = res.rows[serializers.serialize_uint64(to_label(cg, 3, 0, 0, 0, 1))].cells[
            "0"
        ]
        children = attr.deserialize(row[attr.key][0].value)
        assert (
    ...
    def test_build_big_graph(self, gen_graph):
        ...
        assert serializers.serialize_uint64(to_label(cg, 1, 0, 0, 0, 0)) in res.rows
        assert serializers.serialize_uint64(to_label(cg, 1, 7, 7, 7, 0)) in res.rows
        assert serializers.serialize_uint64(to_label(cg, 5, 0, 0, 0, 1)) in res.rows
        assert serializers.serialize_uint64(to_label(cg, 5, 0, 0, 0, 2)) in res.rows
